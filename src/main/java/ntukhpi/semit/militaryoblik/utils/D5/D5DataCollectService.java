...
@Service
public class D5DataCollectService {
    ...
    @Autowired
    public D5DataCollectService(MilitaryPersonService militaryPersonService, PersonalDataService personalDataService, DocumentService documentService, CurrentDoljnostInfoService currentDoljnostInfoService) {
